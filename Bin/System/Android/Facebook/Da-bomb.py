...
def _____________banner():
    numList = ["Banner/Termux/banner01.txt", "Banner/Termux/banner02.txt", "Banner/Termux/banner03.txt", 
    		   "Banner/Termux/banner04.txt", "Banner/Termux/banner05.txt","Banner/Termux/banner06.txt","zonk-Generate"]
    for x in range(1):
...
def _____________Generate____(_variabel__):
    ...
    os.system("clear")
    print(colors.LightRed + "[*] " + colors.LightGreen +
          "Generate Dictionary Type Bullets ")
    time.sleep(2)
...
def print_______________________________(filename, unique_list_finished):
    try:
        ...
        os.system("clear")
        _____________banner()
        print(colors.LightRed + "[+] " + colors.LightGreen + "Now You Need Your Weapon Ready" )
        print(colors.LightRed + "[+] " + colors.LightGreen + filename + colors.LightGreen + " Counting " + colors.LightRed + str(lines) + colors.Default)
        __option_ = input(colors.LightRed + "[+] " + colors.LightGreen +
                          "Start the attack ? Y/[N]: ").lower()
...
def _cartridge():
    ...
    # Input[Random Number]
        ...
        _variabel__["___random___"] = input(
            colors.LightRed + "[*] " + colors.LightGreen + "Tambahkan Angka Acak ? Y/[N]: ").lower()
