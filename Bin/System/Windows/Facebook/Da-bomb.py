...
def _____________banner():
    numList = ["Banner/Windows/banner01.txt", "Banner/Windows/banner02.txt", "Banner/Windows/banner03.txt",
               "Banner/Windows/banner04.txt", "Banner/Windows/banner05.txt", "Banner/Windows/banner06.txt", "Banner/Windows/banner07.txt"]
    for x in range(1):
...
def __banner_worldlis():
    fileBanner_ = open("Banner/Windows/banner03.txt")
    print(' ')
